...
std::optional<Operation *> getCmpSelectResult(OpBuilder &builder, Location loc, arith::CmpFOp op, bool operandsSwapped);
std::optional<Operation *> getCmpSelectResult(OpBuilder &builder, Location loc, arith::CmpIOp op, bool operandsSwapped);
std::optional<Operation *> getCmpSelectResult(OpBuilder &builder, Operation *cmpOp, arith::SelectOp op);
} // namespace triton
} // namespace mlir
