...
config.triton_tools_dir = os.path.join(config.triton_linalg_obj_root, 'bin')
config.filecheck_dir = os.path.join(config.triton_obj_root, 'bin', 'FileCheck')

tool_dirs = [
    config.triton_tools_dir, config.llvm_tools_dir, config.filecheck_dir
]
